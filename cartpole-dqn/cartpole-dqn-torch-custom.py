...
class DQN(nn.Module):
    ...
    def load_model(self):
        self.load_state_dict(torch.load("cartpole-dqn-1.pth"))

    def save_model(self):
        torch.save(self.state_dict(), "cartpole-dqn-1.pth")
...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        if done:
            ...
            # plot_durations()
            print("Episode " + str(i_episode) + ": " + str(t+1))
            break
